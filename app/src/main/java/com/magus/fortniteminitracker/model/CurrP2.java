...
public class CurrP2 {
    ...
    @Expose
    private MinutesPlayed____ minutesPlayed;
    @SerializedName("kpm")
    @Expose
    private Kpm____ kpm;
    @SerializedName("kpg")
    ...
    @Expose
    private ScorePerMin____ scorePerMin;
    ...
    public MinutesPlayed____ getMinutesPlayed() {
        return minutesPlayed;
    }

    public void setMinutesPlayed(MinutesPlayed____ minutesPlayed) {
        this.minutesPlayed = minutesPlayed;
    }

    public Kpm____ getKpm() {
        return kpm;
    }

    public void setKpm(Kpm____ kpm) {
        this.kpm = kpm;
    }
    ...
    public ScorePerMin____ getScorePerMin() {
        return scorePerMin;
    }

    public void setScorePerMin(ScorePerMin____ scorePerMin) {
